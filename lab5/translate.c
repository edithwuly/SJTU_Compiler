...
Tr_exp Tr_Op(A_oper oper, Tr_exp left, Tr_exp right, bool isString) {
	...
	switch (oper) 
	{
		case A_plusOp: 
    		...
    		case A_eqOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_eq, l, r, NULL, NULL));
        	case A_neqOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_ne, l, r, NULL, NULL));
    		case A_ltOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_lt, l, r, NULL, NULL));
    		case A_gtOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_gt, l, r, NULL, NULL));
    		case A_leOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_le, l, r, NULL, NULL));
    		case A_geOp: 
			return Tr_Cx(NULL, NULL, T_Cjump(T_ge, l, r, NULL, NULL));
    	}
